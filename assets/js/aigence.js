(function ($) {
  ...
  // Date Picker
  if ($(".Aigence-datepicker").length) {
    $(".Aigence-datepicker").each(function () {
      $(this).datepicker();
    });
  }
  ...
  //accordion
  if ($(".Aigence-accordion").length) {
    var accordionGrp = $(".Aigence-accordion");
        ...
        $(this)
          ...
          .on("click", function () {
            if ($(this).parent().hasClass("active") === false) {
              $(".Aigence-accordion." + accordionName)
                .find(".accordion")
                .removeClass("active");
              $(".Aigence-accordion." + accordionName)
                .find(".accordion")
  ...
  //Strech Column
  function Aigence_stretch() {
    var i = $(window).width();
    $(".row .Aigence-stretch-element-inside-column").each(function () {
      var $this = $(this),
